        ...
        <div class="교양과정">
            ...
            <table class="교양과정">
                ...
                <tr>
                    ...
                    <td colspan="2" >- 인권과 평화 (2학점)<br>
                        - 대학생활 세미나1 (2학점)<br>
                        - 대학생활 세미나2 (2학점)<br>
                        - 말과 글 (2학점)<br>
                        - 사회봉사1 (2학점)<br>
                        - 비아메디아 채플 (2학점) -> 재학중 2학기 동안 2과목 이수해야함<br>
                        - 과학기술과 에콜로지 (2학점)<br>
                        - 데이터 활용 및 분석 (2학점)
                    </td>
        ...
        <table class="특별과정">
            ...
            <tr>
                ...
                <td>
                    ...
                    두 학기 수료 후 신청 가능 -> 신청이 가능한 자는 취득학점이 34학점 이상<br>
            ...
            <tr>
                <td>연계 전공 과정 </td>
                <td>
                    두 개 이상의 학과의 전공과정과 교양과정을 연계하는 과정이다.)<br>
                    신청하고자 하는 사람은 연계 전공 신청서를 제출하고 승인 받아야함<br>
                    두 학기 수료 후 신청 가능 -> 신청이 가능한 자는 취득학점이 34학점 이상 <br>
                    -> 이수자는 연계전공학점 40학점 이상 취득 해야 함<br>
                    -평생 교육사 과정<br>
                    -교직 과정<br>
                    -해외창 과정<br>
                    -자기 설계 과정<br>
